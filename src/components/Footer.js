...
const SocialLink = styled.a`
  ...
  &:hover {
    ...
    background: ${props => `linear-gradient(to top left, ${props.theme.themeColor}, ${props.theme.themeAccent})`};
    ...
    >
      ...
      >
        {isWideScreen && <>
          ...
          >
            <li>
              <PrimaryLink to="/about" inverted={true}>
                ABOUT
              </PrimaryLink>
            </li>
            <li>
            ...
            <li>
              <PrimaryLink to="/contact" inverted={true}>
                Hire Us
              </PrimaryLink>
            </li>
          </ul>
